...
class MenuItemAdapter(private val context: Context,
                      private val menuDescriptions: ArrayList<MenuItem>): RecyclerView.Adapter<MenuItemViewHolder>()
{
    ...
    {
        return MenuItemViewHolder(LayoutInflater.from(context).inflate(R.layout.menu_item, parent, false))
    }
}