...
import com.timmytruong.timmypos.utils.ui.DialogOptionItemViewHolder
                               ...
                               private val dialogItemClickListener: DialogItemClickListener): RecyclerView.Adapter<DialogOptionItemViewHolder>()
{
    ...
    {
        return DialogOptionItemViewHolder(LayoutInflater.from(context).inflate(R.layout.dialog_option_item, parent, false), dialogItemClickListener)
    }
