            ...
            override fun onItemClicked(position: Int, tag: String)
            {
                when (tag)
                {
                    AppConstants.SIZE_OPTION_TAG -> {
                        ...
                        {
                            if (sizesArray[index].getCheckedStatus() && index != position)
                            {
                                sizesArray[index].setCheckedStatus(false)
                            }
                            else if (sizesArray[index].getCheckedStatus() && index == position)
                            {
                                sizesArray[index].setCheckedStatus(false)
                            }
                            else if (!sizesArray[index].getCheckedStatus() && index == position)
                            {
                                sizesArray[index].setCheckedStatus(true)
                            }
                        }
                        ...
                        sizeCost =
                            if (sizesArray[position].getCheckedStatus())
                            {
                                sizesArray[position].getUnitValue().toFloat()
                            }
                            else
                            {
                                0f
                    ...
                    AppConstants.EXTRA_OPTION_TAG -> {
                        var unitValue: Float = extrasArray[position].getUnitValue().toFloat()

                        when (extrasArray[position].getCheckedStatus())
                        {
                            true -> unitValue = -unitValue
                        }

                        extrasArray[position].setCheckedStatus(!extrasArray[position].getCheckedStatus())
